  ...
  class DataSaver {
    ...
    _keepSystemEvent(evt) {
      ...
      return [
        ...
        "collaboration_intro_instruction_show",
        "collaboration_intro_instruction_ack",
        "main_phase_goal_instruction_show",
        "main_phase_goal_instruction_ack",
        "rep_partner_ready_instruction_show",
        "rep_partner_ready_instruction_ack",
        "game_start",
        "game_end",
        "session_end",
    ...
    _normalizeRoleAction(evt, autoRt) {
      ...
      const out = {
        ...
        success: evt.success ?? "",
        reason: evt.reason || "",
        auto_recovery: evt.auto_recovery ?? "",
        security_distance: evt.security_distance ?? "",
        steps_required: evt.steps_required ?? "",
        rounds_wasted: evt.rounds_wasted ?? "",
    ...
    _normalizeSystem(evt, autoRt) {
      ...
      const out = {
        ...
        auto_recovery: evt.auto_recovery ?? "",
        security_label: evt.security_label || "",
        security_distance: evt.security_distance ?? "",
        steps_required: evt.steps_required ?? "",
        rounds_wasted: evt.rounds_wasted ?? "",
    ...
    _preferredHeaders(allKeys) {
      const preferred = [
        ...
        "actor_type", "role", "action", "key", "dir", "rt_ms",
        "repetition", "round", "turn_global", "turn_index_in_round", "move_index_in_turn", "step_number", "step_total",
